...
Route::group(['middleware' => ['auth', 'role:shipper']], function () {
    Route::get('/supper-admin', [UserController::class, 'index'])->name('show-admins');
    Route::resource('users', UserController::class);
    Route::post('/add-admin',[UserController::class,'newAdmin'])->name('add-admin');
});
